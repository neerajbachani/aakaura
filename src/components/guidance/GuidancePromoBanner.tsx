  ...
  return (
    <div className={`text-center ${className}`} role="status">
      <div className="flex items-center justify-center gap-3 mb-3">
        ...
        <span className="text-[#BD9958]/75 text-[10px] md:text-xs uppercase tracking-[0.3em] font-light">
          From 30 September
        </span>
      ...
      <p className="font-cormorant text-[#F5E6D3]/90 text-base md:text-lg lg:text-xl font-light leading-relaxed italic max-w-xl mx-auto">
        The first 50 guidance calls are complimentary, from Aakaura&apos;s side.
      </p>
    </div>
  );
}
