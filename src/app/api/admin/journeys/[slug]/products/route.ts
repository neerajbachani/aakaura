...
export async function POST(
    ...
    try {
        ...
        const priceNum = parseFloat(String(product.price || "0").replace(/[^0-9.]/g, '')) || 0;
        const offerPriceNum = product.offerPrice ? parseFloat(String(product.offerPrice).replace(/[^0-9.]/g, '')) || null : null;
