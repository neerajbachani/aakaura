...
export default function RitualAwarenessGuide() {
  return (
    <div className="grid grid-cols-1 gap-12 lg:gap-16">
      <NoteSection number="01" title="What This Is (And What It Isn't)">
        ...
        <p className="mb-4">
          They are not medical, psychological, or therapeutic treatments, and
          are not intended to diagnose, treat, cure, or prevent any physical or
          mental health condition.
        </p>
        <p className="mb-2 md:mb-3">We do not claim that any product:</p>
        <ul className={listClass}>
          <li>
            Activates specific chakras in a measurable or medically proven way
          </li>
          <li>Removes &ldquo;blockages&rdquo; in a clinical sense</li>
          <li>Produces guaranteed outcomes</li>
        </ul>
        <p className="mb-2 md:mb-3">
          However, when used with intention and consistency, these interactions
          may:
        </p>
        <ul className={listClass}>
      ...
      <NoteSection number="02" title="The Only Thing You Need to Remember">
        <p className="mb-4">
        ...
        <p>These rituals are about experiencing yourself more consciously.</p>
      </NoteSection>

      <NoteSection number="03" title="Ritual… Interaction… Same Thing, Relax">
        <p className="mb-4">
        ...
        <p>
          Nothing here is meant to feel rigid, forced, or performative. This very
      ...
      >
        <p className="mb-4">
          Aakaura does not &ldquo;help&rdquo; or &ldquo;fix&rdquo; your life.
        </p>
      ...
      <NoteSection number="06" title="Don't Perform It. Experience It.">
        <p className="mb-4">
          This isn&apos;t a test. Please do not treat it as one (unconsciously).
        </p>
        <ul className={listClass}>
          <li>Do not try to memorize rituals mechanically</li>
          <li>
            Focus on understanding the interaction, not performing it perfectly
          </li>
      ...
      <NoteSection number="07" title="This Only Works If You Let It">
        ...
        <p className="mb-4">
          Behavioral conditioning tools, presented through physical and symbolic
          forms
        </p>
      ...
      >
        <p>
          And that&apos;s important to understand. You are your own divine, own
          help and own guide. We are, however, in this, together forever.{" "}
          &lt;3
        </p>
      </NoteSection>
      ...
      >
        ...
        <ul className={listClass}>
          ...
          <li>You are responsible for your interpretation and experience</li>
          <li>
      ...
      >
        <p className="mb-4">
          These are not machine-perfect objects or generic instructions, and
          that is intentional.
        </p>
        ...
        <ul className={listClass}>
          <li>Carefully written, proofread, and intentionally curated</li>
          <li>Developed with input from energy practitioners</li>
          <li>
            Informed by individuals who study neuroscience, science, and related
            disciplines
          </li>
        </ul>
      </NoteSection>
      ...
      <NoteSection number="11" title="This Will Evolve (Like You Should)">
        <p className="mb-4">Aakaura is a continuously evolving system.</p>
        <p className="mb-2 md:mb-3">
        ...
        <ul className={listClass}>
          ...
          <li>Evolving understanding of energy and behavior</li>
        </ul>
      </NoteSection>

      <NoteSection number="12" title="Language, But Make It Easy">
        <p className="mb-4">Rituals may use English numbering for clarity</p>
        <p className="mb-4">
          Content may be available in multiple languages (including Hindi and
          English)
        </p>
        <p>
      ...
      <NoteSection number="14" title="If You've Read This, You're In">
        <p className="mb-4">And that already sets you apart.</p>
        <p className="mb-2 md:mb-3">
          By entering your password and accessing the ritual content, you confirm
          that:
        </p>
        <ul className={listClass}>
          <li>You have read and understood this document</li>
          <li>You accept the nature and limitations of the product</li>
