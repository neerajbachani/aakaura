...
export default async function CombosPage() {
  ...
  const journeyProducts: JourneyProduct[] = combos.map((combo, index) => {
    ...
    return {
      ...
      includedProducts: combo.products.map((cp) => {
        const normalize = (str: string) =>
          str.toLowerCase().replace(/[^a-z0-9]/g, "");
