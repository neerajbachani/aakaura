      ...
      <div className="min-h-screen bg-[#27190B] py-8 pt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center py-24 bg-[#191919] rounded-2xl border border-[#BD9958]/20 shadow-2xl">
            <h1 className="text-3xl font-semibold text-[#BD9958] font-cormorant mb-4 tracking-wide">
              Your cart is empty
            </h1>
            <p className="text-[#BD9958]/70 mb-8 text-lg">
              Add some items to your journey before checking out.
            </p>
            <Link
              href="/products"
      ...
      <div className="min-h-screen bg-[#27190B] py-8 pt-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#BD9958] font-cormorant tracking-wide">
              Checkout
            </h1>
          </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-10">
              ...
              <div className="lg:col-span-8">
                <div className="space-y-8">
                  ...
                  >
                    <h2 className="text-2xl font-semibold text-[#BD9958] font-cormorant mb-6 tracking-wide">
                      Contact Information
                    </h2>
                  ...
                  >
                    ...
                    <div className="p-4 rounded-lg bg-[#27190B] border border-[#BD9958]/10 text-center">
                      <p className="text-base text-[#BD9958]/80 leading-relaxed">
                        ...
                        <span className="text-[#BD9958] font-semibold">
                          Razorpay
                        </span>{" "}
                        upon clicking "Proceed to Payment". All major credit
                        cards, UPI, and net banking are supported.
                      </p>
                    </div>
                  </motion.div>
                </div>
